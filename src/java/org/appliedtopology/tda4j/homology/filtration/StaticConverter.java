...
public class StaticConverter extends FiltrationConverter {
	...
	/* (non-Javadoc)
	 * @see org.appliedtopology.tda4j.homology.filtration.FiltrationConverter#getFiltrationIndex(double)
	 */
	...
	/* (non-Javadoc)
	 * @see org.appliedtopology.tda4j.homology.filtration.FiltrationConverter#getFiltrationValue(int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.appliedtopology.tda4j.homology.filtration.FiltrationConverter#computeInducedFiltrationValue(double, double)
	 */
	...
	/* (non-Javadoc)
	 * @see org.appliedtopology.tda4j.homology.filtration.FiltrationConverter#getInitialFiltrationValue()
	 */
