...
public abstract class FiltrationConverter implements ObjectObjectFunction<Interval<Integer>, Interval<Double>> {
	...
	/* (non-Javadoc)
	 * @see org.appliedtopology.tda4j.homology.filtration.FiltrationConverter#transformInterval(org.appliedtopology.tda4j.homology.barcodes.IntHalfOpenInterval)
	 */
