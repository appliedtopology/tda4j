 ...
 * @author autogen
 *
 * @param <boolean> ring of scalars
 * @param <M> the underlying data type
 */
public interface BooleanAbstractModule<M> {
	/**
	 ...
	 * @return r * a
	 */
	public abstract M multiply(boolean r, M a);
	 ...
	 */
	public abstract void accumulate(M a, M b, boolean r);
}
