 ...
 *
 */
public class DoubleObjectPair<U> {
	/*
	 ...
	 */
	public DoubleObjectPair(double first, U second) {
		this.first = first;
		this.second = second;
	}
	
	/**
	 * Constructor which initializes from another DoubleObjectPair<U>.
	 * 
	 * @param pair the DoubleObjectPair<U> to initialize from
	 */
	public DoubleObjectPair(DoubleObjectPair<U> pair) {
