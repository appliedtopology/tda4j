...
public class ObjectBooleanPair<T> {
	...
	/**
	 * Constructor which initializes from another ObjectBooleanPair<T>.
	 * 
	 * @param pair the ObjectBooleanPair<T> to initialize from
	 */
	public ObjectBooleanPair(ObjectBooleanPair<T> pair) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final ObjectBooleanPair<?> other = (ObjectBooleanPair<?>) obj;
