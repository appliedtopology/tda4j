...
import org.appliedtopology.tda4j.algebra.autogen.algebraic.IntAbstractRing;
 ...
 */
public class IntAlgebraicFreeModule<M> implements IntAbstractModule<IntSparseFormalSum<M>> {
	/**
