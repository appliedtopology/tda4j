...
//
///**
// * Defining trait for being an element of some simplicial set.
// * Elements keep track of their own dimension, what degeneracies (if any) have been applied,
// * and what the base non-degenerate element is.
// */
...
//}
//
//given SimplicialSetElement is HasDimension:
...
//
///**
// * Wrapper class to allow any data type with a defined dimension function (as witnessed by
// * the typeclass [[HasDimension]] to be a base element for a [[SimplicialSetElement]].
// *
// * @param wrapped
...
//
///**
// * Primary class for representing a generic [[SimplicialSetElement]]. This case class carries references
// * to its base element and a list of degeneracies. (both [[simplicialGenerator]] and [[SimplicialWrapper]]
// * will specifically create elements without degeneracies and are meant to be used as base elements)
// *
// * If you have no reason to build something else, your simplicial set elements should probably be
// * instances of this case class.
// *
// * Instantiation is through the companion object, where the public constructor does some normalization on
// * the data the object carries.
// *
// * @param base
// * @param degeneracies
// */
...
///*
//   given normalizedHomologyCell: [SimplicialSetElement : {Ordering as seOrd, HasDimension as hasDim}] => (SimplicialSetElement is OrderedCell):
...
//
//  /**
//   * Factory method for [[SimplicialSet]]s using the [[LazySimplicialSet]] implementation.
//   * This method will ensure that
//   *
//   * 1. You have face mappings defined for all your generators, and
//   * 2. You have the correct number of face mappings for each generator.
//   *
//   * If your case is finite, but too expensive to do these checks, use the [[LazySimplicialSet]] constructor
//   * directly.
//   *
//   * @param generators
//   * @param faceMapping
...
//   * sub-simplices of simplices in `underlying` and weed out duplicates - which may duplicate work if you
//   * already have a full simplicial complex in place. Use [[fromAll]] if you have all simplices already.
//   *
//   * @param underlying
//   * @tparam VertexT
//   * @return
...
//    fromAll(underlying.toSet.flatMap(spx => spx.toSet.subsets.filter(_.nonEmpty)).map((s) => Simplex.from(s.toSeq)).toSeq)
//
//  /**
//   * Create a [[Singular]] simplicial set from the simplices in `allSimplices`. This method will trust the
//   * caller to have generated all sub-simplices appropriately.
//   *
//   * @param allSimplices
//   * @tparam VertexT
//   * @return
...
//
///**
// * Helper function to create a [[CellStream]] instance from any simplicial set.
// * If no filtration value function is provided, it will use the constant function with the `smallest` value in the
// * [[Filterable]] typeclass implementation for `FiltrationT`.
// *
// * @param ss
...
// * through one of them completely before going to the other one.
// *
// * @param left
// * @param right
// * @tparam A
...
//
///**
// * The coproduct of two simplicial sets, defined as the simplicial set generated by the union of generators
// * of the two lists.
// *
// * If simplices happen to be in both the factors, this implementation currently makes no effort to distinguish them.
// * Face maps will be tried from both factors, using the left-most that is actually defined on the given element.
// * Both of these implementation choices may be unwise.
// *
// * @param left
// * @param right
// */
...
//
//  /*
//  given productCell: (ProductElement is OrderedCell):
