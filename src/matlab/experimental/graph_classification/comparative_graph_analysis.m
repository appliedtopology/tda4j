function [bottleneck_distances] = comparative_graph_analysis(generators, query_graphs, K)
    ...
    parfor m = 0:(K*G - 1)
        ...
        distances = org.appliedtopology.tda4j.graph.utility.GraphUtility.computeShortestPaths(graph);
    ...
    parfor m = 1:K2
        distances = org.appliedtopology.tda4j.graph.utility.GraphUtility.computeShortestPaths(query_graphs{m});
        [Y] = cmdscale(distances);
