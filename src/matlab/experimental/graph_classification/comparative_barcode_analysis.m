function bottleneck_distances = comparative_barcode_analysis(distance_matrices1, distance_matrices2, max_metric_size)
    ...
    for k = 1:(K1 + K2)
        ...
        dim_0_intervals = org.appliedtopology.tda4j.bottleneck.BottleneckDistance.truncate(dim_0_intervals, 0, max_filtration_value);
    ...
    parfor m = 0:(K1 * K2 - 1)
        ...
        bottleneck_distances(m + 1) = org.appliedtopology.tda4j.bottleneck.BottleneckDistance.computeBottleneckDistance(interval_collections1{k1}, interval_collections2{k2});
