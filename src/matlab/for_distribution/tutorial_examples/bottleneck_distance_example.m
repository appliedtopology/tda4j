...
bottleneck_distance_dim0 = org.appliedtopology.tda4j.bottleneck.BottleneckDistance.computeBottleneckDistance(intervalsA_dim0,intervalsB_dim0)
intervalsA_dim1=intervalsA.getIntervalsAtDimension(1);
intervalsB_dim1=intervalsB.getIntervalsAtDimension(1);
bottleneck_distance_dim1 = org.appliedtopology.tda4j.bottleneck.BottleneckDistance.computeBottleneckDistance(intervalsA_dim1,intervalsB_dim1)
